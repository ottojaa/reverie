...
- Skip LLM text processing, optionally use vision model instead
...
- Note: LLM will refine this classification with better accuracy
...
- LLM may still extract useful metadata
