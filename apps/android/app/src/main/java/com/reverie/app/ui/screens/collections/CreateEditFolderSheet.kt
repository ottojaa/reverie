    ...
    ModalBottomSheet(
        ...
        Column(
            modifier = Modifier
                ...
                // Lift above the keyboard and scroll the content, so focusing the Name/Description
                // field scrolls it into view instead of shoving the icon grid off the top.
                .imePadding()
