...
let globalConfirm: (options: ConfirmOptions) => Promise<boolean> = () => Promise.reject(new Error('ConfirmProvider not mounted'));
            ...
            <AlertDialog open={!!pending} onOpenChange={handleOpenChange}>
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction variant={pending?.variant ?? 'default'} onClick={handleConfirm}>
